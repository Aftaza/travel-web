      ...
      <section className="flex gap-8 px-12 py-8">
        <div className="flex flex-col gap-4 w-1/2">
          ...
          <div className="bg-[#efefef] p-4 flex flex-col gap-2 rounded-md text-sm text-[#333333]">
            <li>
              Gratis untuk anak usia di bawah 6 tahun dan pengunjung disabilitas
              (74%+)
            </li>
            <li>
              Ibu hamil, anggota keluarga dengan stroli, dan pengunjung dengan
              tongkat bantu jalan dapat membeli tiket prioritas di tempat
            </li>
          </div>
          <div className="rounded-md outline-[#efefef] outline outline-1 flex justify-between items-center p-2">
            <div className="flex flex-col">
              <h3 className="font-semibold">Remaja (18+)</h3>
              <h3 className="font-semibold text-[#FA8B02]">Rp.12.000</h3>
            </div>
            <div className="flex">
              <button onClick={decrease} className="w-8 h-8 outline outline-1 text-lg grid place-content-center rounded-sm">-</button>
              <div className="w-8 h-8 outline outline-1 text-lg grid place-content-center bg-[#efefef]">{counter}</div>
              <button onClick={increase} className="w-8 h-8 outline outline-1 text-lg grid place-content-center rounded-sm">+</button>
            </div>
          </div>
          <div className="rounded-md outline-[#efefef] outline outline-1 flex justify-between items-center p-2">
            <div className="flex flex-col">
              <h3 className="font-semibold">Anak (6-17)</h3>
              <h3 className="font-semibold text-[#FA8B02]">Rp.12.000</h3>
            </div>
            <div className="flex">
              <button onClick={decrease} className="w-8 h-8 outline outline-1 text-lg grid place-content-center rounded-sm">-</button>
          ...
          <div className="rounded-md outline-[#efefef] outline outline-1 flex justify-between items-center p-2">
            <div className="flex flex-col">
              <h3 className="font-semibold">Balita</h3>
              <h3 className="font-semibold text-[#FA8B02]">Rp.12.000</h3>
            </div>
            <div className="flex">
              <button onClick={decrease} className="w-8 h-8 outline outline-1 text-lg grid place-content-center rounded-sm">-</button>
