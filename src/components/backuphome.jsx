...
export default function Home() {
  ...
  return (
    <main className="flex flex-col w-[100vw]">
      <section className="h-[100vh] w-full pt-[100px] px-8 md:px-12 relative">
        <video autoPlay loop muted className="inset-0 absolute object-cover h-full">
        ...
        <div className="flex flex-col gap-2 h-1/2 md:w-1/2 drop-shadow-md md:text-left text-center">
          ...
          <button className="bg-[#4CACBC] rounded-3xl text-xl text-[#ffffff] font-semibold flex flex-row justify-center items-center gap-2 p-2 w-1/3 self-center md:self-start">
            Explore
            <svg
              width="36"
              height="11"
        ...
        <div className="h-fit flex justify-center">
          <div className="bg-color-white rounded-2xl p-3 h-fit flex justify-center gap-3 md:w-1/3 drop-shadow-md">
      ...
      <section className="min-h-dvh px-8 md:px-12 pt-8 flex flex-col gap-8">
        <div className="flex flex-col gap-8">
          ...
          <div className="h-[65dvh] flex justify-between gap-2 w-full overflow-x-scroll">
            <div className="md:w-[30%] rounded-3xl h-full bg-color-fourty overflow-hidden relative aspect-square flex-none group transition ease-in-out">
              <p className="absolute font-semibold z-10 text-color-white text-4xl inset-0 grid place-content-center group-hover:-translate-x-72 transition ease-in-out">
                Gunung
              </p>
              <p className="absolute -translate-x-24 group-hover:translate-x-4 top-3 font-semibold z-10 text-color-white text-xl transition ease-in-out">
                Gunung
              </p>
              <Image src="/images/bromo.jpg" fill={true} alt="Bromo" className="group-hover:scale-110 transition ease-in-out"/>
            </div>
